  ...
  return (
    <section className="colors-2">
            <div id="amenities" className="home-grid">
                ...
                <motion.h2 className="small-font-4" initial={{ opacity: 0, y: 65 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 1 }} viewport={{ margin: "-100px", once: true }} >AMENITIES</motion.h2>
