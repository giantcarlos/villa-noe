  ...
  return (
    <motion.section variants={item} initial="hidden" animate="show" transition={{duration: 1, delay: .25}} className="colors-2">
        <motion.div variants={container} initial="hidden" animate="show" className="details">
            ...
            <motion.p variants={item2} className="noe-paragraph">Noe Taiño studied law at the University of Santo Tomas, served as a soldier during World War II, and later worked at the National Treasury of the Philippines. He married Cornelia Javaluyas, a teacher, and together they raised their family.</motion.p>
            <motion.figure variants={item2} className="couple-image">
              <img src="couple.jpg" alt="Noe and Cornelia Taino."></img>
              <figcaption className="couple-cap">Noe and Cornelia Taiño</figcaption>
            </motion.figure>
