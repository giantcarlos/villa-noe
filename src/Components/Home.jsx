  ...
  return (
    <motion.section variants={item} initial="hidden" animate="show" transition={{duration: 1.25, delay: .125}} className="home">
        <div className="home-grid">
            <motion.img variants={reveal} initial="hidden" animate="show" transition={{duration: .75, delay: 1.25}}className="home-image" alt="Sunrise on Villa Noe Beach sign." src="sunrise.jpg" />
