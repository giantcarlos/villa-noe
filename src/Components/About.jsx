  ...
  return (
    <section className="about">
            <div className="home-grid">
                ...
                <motion.p className="paragraph" variants={item2} initial="hidden" animate="show" transition={{duration: .5, delay:1.375}}>Nestled on the pristine shores of Cagbalete Island in Mauban, Quezon, Villa Noe Beach offers a peaceful retreat with clear waters, white sand, and breathtaking sunsets. Whether you’re here to unwind by the beach, explore the island’s marine life, or simply enjoy the tranquility, our resort provides a comfortable and scenic escape from the everyday.</motion.p>
