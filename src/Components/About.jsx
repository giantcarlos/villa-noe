  ...
  return (
    <section className="about">
            <div className="home-grid">
                <motion.img initial={{ opacity: 0, y: 65 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 1.125 }} viewport={{ margin: "-200px", once: true }} className="about-image" alt="Sunrise on Villa Noe Beach sign." src="cagbalete.jpg" />
